...
<body>
  ...
  <section id="home">
    ...
    <div class="tengah aos-init aos-animate" data-aos="fade-down">
      ...
      <p class="negro tengah">Version: 18.23.35</p>
      <br>
      <tr>
        <td>
      ...
      <p>
        <br>
        <img style="display: inline" loading="lazy" src="img/revanced/revanced1.jpg" alt="" width="140"
          height="300">
        <img style="display: inline" loading="lazy" src="img/revanced/revanced2.jpg" alt="" width="140"
          height="300">
        <img style="display: inline" loading="lazy" src="img/revanced/revanced3.jpg" alt="" width="140"
          height="300">
      </p>
    </div>
  </section>
